<div class="container-fluid">
  <%= _.template($('#input_constructor').html())(
    {
      id: "Data", 
      description: tr("String variable to check"), 
...
<div class="tooltipinternal">
    ...
    <div class="tr tooltip-paragraph-fold">Please note that if you specify as a variable for checking not a string, but a variable of any other type - the result will always be <span style="color:black">false</span>.</div>
