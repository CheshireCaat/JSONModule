	...
	<%= _.template($('#variable_constructor').html())(
		{
			...
			help:
			{
				description:tr("This variable will be set to number of elements matching JPath or simple JSON query.")
			}
		}) %>
</div>
<div class="tooltipinternal">
    <div class="tr tooltip-paragraph-first-fold">Execute JPath query if needeed and get elements count.</div>
