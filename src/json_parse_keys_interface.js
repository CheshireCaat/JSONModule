	...
	<%= _.template($('#variable_constructor').html())(
		{
			...
			help:
			{
				description:tr("This variable will be set string or an array that matches JPath or simple JSON query and contain the key.")
			}
		}) %>
</div>
<div class="tooltipinternal">
    <div class="tr tooltip-paragraph-first-fold">Execute JPath query if needeed and get all keys.</div>
